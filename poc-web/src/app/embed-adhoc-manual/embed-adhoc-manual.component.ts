...
@Component({
  selector: 'app-embed-adhoc-manual',
  templateUrl: './embed-adhoc-manual.component.html',
  styleUrls: ['./embed-adhoc-manual.component.scss']
})
export class EmbedAdhocManualComponent {
  ...
  quickCreateConfig: IQuickCreateConfiguration = {
    ...
    reportCreationMode: models.ReportCreationMode.Default,
